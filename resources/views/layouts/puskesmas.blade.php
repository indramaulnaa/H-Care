...
<head>
    ...
    <style>
        ...
        .sidebar {
            min-height: 100vh; width: 260px; background: #fff;
            position: fixed; top: 0; left: 0;
            border-right: 1px solid #e9ecef; z-index: 1000;
        }
        .main-content { margin-left: 260px; padding: 30px; }
        .nav-link {
            color: #6c757d; padding: 12px 20px; margin-bottom: 5px;
...
<body>
    ...
    <div class="sidebar d-flex flex-column p-3">
        <div class="d-flex align-items-center gap-2 mb-4 px-2 py-3 border-bottom">
            ...
            <div>
                <h6 class="m-0 fw-bold text-primary">H-Care</h6>
                <small class="text-muted" style="font-size: 11px;">{{ Auth::user()->nama_unit }}</small>
            </div>
        </div>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="{{ route('puskesmas.cuti') }}" class="nav-link {{ Request::is('puskesmas/cuti*') ? 'active' : '' }}">
                    <i class="bi bi-calendar2-check"></i> Pengajuan Cuti
                </a>
            </li>
            
            <li class="nav-item mt-3 mb-1 text-muted small fw-bold px-3">KEPEGAWAIAN</li>
        ...
        <div class="mt-auto pt-4 border-top">
            <div class="d-flex align-items-center px-2 mb-3">
                <div class="flex-grow-1">
                    <strong class="d-block text-dark small">{{ Auth::user()->name }}</strong>
                </div>
            </div>
